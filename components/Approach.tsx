  ...
  return (
    <section className="w-full py-20">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
            ...
            description = "We'll collaborate to map out your website's hoals, target audience, and key functionalities. We'll discuss things like site structure, navigation, and content requirements."
            >
            <CanvasRevealEffect
                animationSpeed={5.1}
            ...
            description = "Once we agree on the plan, I will immediately dive into coding. From intial sketches to polished code, I keep you updated every step of the way."
            >
            <CanvasRevealEffect
                animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 top-[50%] left-[50%] translate-y-[50%] group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
